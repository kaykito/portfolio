  ...
  return (
    <Fragment>
      ...
      <div className="about_text w-full h-auto clear-both float-left border-solid border-[#DFDFDF] border-b pb-[31px] mb-[30px]">
        <p className="mb-[11px]">
          Hi, my name is Rizki Satriyo aka Kaykikun and I began using PHP when it first
          began. I’ve spent most of my waking hours for the last seven years
          ...
          <div className="tokyo_tm_info w-full h-auto clear-both float-left">
            <ul className="m-0 list-none">
              ...
              <li className="m-0">
                ...
                <span>Kramatjaya, Malausma, Majalengka</span>
              </li>
              <li className="m-0">
                <span className="min-w-[100px] float-left mr-[10px] font-bold text-black">
                  Email:
